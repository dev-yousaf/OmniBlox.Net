...
{
    /// <inheritdoc />
    public partial class Products_AddProductEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarcodeSymbology = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    TaxRate = table.Column<decimal>(type: "numeric(5,2)", nullable: true),
                    AlertQuantity = table.Column<int>(type: "integer", nullable: true),
